...
import static com.syscort.nipm.R.id.eventtime;
...
public class ArticleDisplay extends AppCompatActivity {
    ...
    TextView desc1, title1, writer1, date1;
    String desc, title, writer, date;
    TextInputLayout ti;
    String pqr;

    String name, password;
    private final String serverUrl = "http://nipmaurangabad.com/articleclick.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //backbutton pressed
                Intent i = new Intent(ArticleDisplay.this, Upcoming.class);
                startActivity(i);
                finish();
            }
        });
        ...
        writer1  = (TextView)findViewById(R.id.writer);
        date1  = (TextView)findViewById(R.id.date);


        final ProgressDialog progress = new ProgressDialog(this);
        progress.setTitle("Loading");
        progress.setMessage("Getting Article ready...");
        ...
        Thread t = new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("aid", pqr));  // $Edittext_value = $_POST['Edittext_value'];
                    ...
                    ArticleDisplay.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ...
                            for (int i = 0; i < list1.length(); i++) {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if(desc.length()!=0)
                                            desc1.setText(Html.fromHtml("<b>Content :</b> "+desc));
                                        else
                                            desc1.setText(Html.fromHtml("<b>Content : </b>Not Available"));

                                        if(writer.length()!=0)
                                            writer1.setText(Html.fromHtml("<b>Writer : </b>"+writer));
                                        else
                                            writer1.setText(Html.fromHtml("<b>Writer : </b>Not Available"));

                                        if(date.length()!=0)
                                            date1.setText(Html.fromHtml("<b>Published Date : </b>"+date));
                                        else
                                            date1.setText(Html.fromHtml("<b>Published Date : </b>Not Available"));
...
//                            });
                        ...
                        Toast.makeText(ArticleDisplay.this, "Cant fetch info", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent i = new Intent(ArticleDisplay.this, Articles.class);
        startActivity(i);
        finish();
