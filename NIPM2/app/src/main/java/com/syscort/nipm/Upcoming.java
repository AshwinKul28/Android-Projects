...
public class Upcoming extends AppCompatActivity {
    ...
    JSONObject jsonobj;
    private final String serverUrl = "http://nipmaurangabad.com/eventfuture.php";
    String abc;
    ImageView material;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //backbutton pressed
                Intent i = new Intent(Upcoming.this, Events.class);
                startActivity(i);
                finish();
            }
        });
        ...
        if (!isNetworkAvailable()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Upcoming.this);
            ...
            progress.setMessage("Getting Events information ready...");
            ...
            Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Upcoming.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
...
//            mRecyclerView.setAdapter(mAdapter);
            ...
            mRecyclerView.addOnItemTouchListener(    new RecyclerItemClickListener1(getApplicationContext(), mRecyclerView ,new RecyclerItemClickListener1.OnItemClickListener() {
                @Override public void onItemClick(View view, int position) {
                    ...
                    Intent i = new Intent(Upcoming.this,EventDescription.class);
                    i.putExtra("roll",abc);
                    startActivity(i);
                    finish();

//                    Toast.makeText(Upcoming.this, "Clcked on this id = "+abc, Toast.LENGTH_SHORT).show();
                }
